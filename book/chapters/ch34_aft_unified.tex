...
% ═══════════════════════════════════════════════════════════════════════════
\begin{nameorigin}
\term{Locally presentable category} (also \emph{locally finitely
presentable}, when $\kappa = \omega$) was introduced by
\emph{Pierre Gabriel} and \emph{Friedrich Ulmer} in 1971
(\emph{Lokal präsentierbare Kategorien}). The term ``locally
presentable'' means ``presentable at each object via a small
presentation'' — every object is a $\kappa$-filtered colimit of
$\kappa$-compact objects. The terminology was extended to
$\infty$-categories by Lurie (HTT 2009; cross-ref Vol IV Ch.~52).
\end{nameorigin}
