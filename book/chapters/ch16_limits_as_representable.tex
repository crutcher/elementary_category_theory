...
% ─────────────────────────────────────────────────────────────────────────────
\begin{nameorigin}
\term{Cone} (over a diagram) is from geometric intuition: visualize the
apex of the cone as a single point connected by arrows down to all
``base'' objects of the diagram. The metaphor is geometric (a literal
geometric cone has an apex and a base); the categorical generalization
keeps the picture but replaces the geometric base with an arbitrary
diagram. Mac Lane's terminology, standard from the 1960s.
\end{nameorigin}
