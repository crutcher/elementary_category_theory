...
% ═══════════════════════════════════════════════════════════════════════════
\begin{nameorigin}
\term{Adjunction in a 2-category} extends the $\mathbf{Cat}$-specific
adjunctions of Vol I Ch.~7 to any $2$-category. The formalization is due
to \emph{Ross Street}, \emph{Max Kelly}, and others working in the
formal-theory-of-monads tradition (early 1970s). The terminology
(``adjunction in $\mathcal{K}$,'' ``$2$-categorical adjunction'') is
standard; some authors use ``adjoint pair'' for the same thing.
Cross-ref Vol III Ch.~32 (formal theory of monads) and Vol IV Ch.~50
