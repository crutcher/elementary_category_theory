...
% ═══════════════════════════════════════════════════════════════════════════
\begin{readernote}
This chapter is synthesis, not new material: every term used has been
introduced in its home chapter with etymology and historical context.
The retrospective ``one picture'' framing assembles those threads into
the formal-spine landscape that Volume III delivers. Volume IV
(``Toward Higher Category Theory'') begins immediately after.
\end{readernote}
