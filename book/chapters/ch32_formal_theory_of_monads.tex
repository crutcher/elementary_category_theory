...
% ═══════════════════════════════════════════════════════════════════════════
\begin{nameorigin}
The \term{formal theory of monads} is due to \emph{Ross Street} (1972),
who developed the theory in his paper \emph{The Formal Theory of
Monads}. The adjective ``formal'' marks the contrast with the concrete
$1$-categorical monads of Vol I Ch.~8: Street's monads live in any
$2$-category $\mathcal{K}$, with $\mathbf{Cat}$ as one example among
many. The formal viewpoint reveals that the Eilenberg-Moore and Kleisli
constructions are themselves universal $2$-categorical adjoints, and
that many monadic phenomena are special cases of $2$-categorical
patterns. Cross-ref Vol IV Ch.~51 for the $\infty$-categorical
generalization.
\end{nameorigin}
