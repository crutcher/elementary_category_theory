...
% ═══════════════════════════════════════════════════════════════════════════
\begin{nameorigin}
\term{Monad} is from Greek \emph{monas} (``unit, single thing''). The
term was introduced by \emph{Saunders Mac Lane} in 1971 (\emph{Categories
for the Working Mathematician}), displacing two earlier names:
\emph{triple} (Eilenberg-Moore 1965; ``triple'' because a monad is the
triple $(T, \eta, \mu)$) and \emph{standard construction} (Godement
1958). Mac Lane chose ``monad'' partly for its connection to Leibniz's
philosophical \emph{monads} (single, indivisible substances) and partly
because the categorical structure really is a ``single algebraic object''
on the endofunctor category.

\term{Eilenberg-Moore category} of $T$-algebras is named for
\emph{Eilenberg} (cross-ref Vol I Ch.~2) and \emph{John Moore}; their
1965 paper formalized the notion. \term{Kleisli category} is named for
\emph{Heinrich Kleisli} (1930--2011, Swiss mathematician), whose 1965
note introduced the construction.
\end{nameorigin}
